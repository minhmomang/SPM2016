...
public class SearchController {
	...
	public void get_favourite_product_in_day(
		...
		json = SearchDAL.get_favourite_product_in_date("2","",Integer.parseInt(f_row),Integer.parseInt(record));
		//////System.out.println(json);
		responseUtf8.response_Utf8(response, json);
	}
	...
	public void get_favourite_product_in_year(
		...
		String json = "";
		ArrayList<ProductData> list;
		json = SearchDAL.get_favourite_product_in_date("3","",Integer.parseInt(f_row),Integer.parseInt(record));
		responseUtf8.response_Utf8(response, json);
	}
